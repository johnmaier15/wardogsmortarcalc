/**
 * Firing tables for WARDOGS indirect-fire weapons.
 *
 * Each table row is [rangeMeters, elevationMils]. Values are community
 * measurements taken from the open-source WARDOGS Artillery Calculator by
 * Apollyon (https://github.com/apollyon-sys/wardogs-calculator, MIT License).
 * They are not an official BULKHEAD publication and may drift between
 * game patches. Rows beyond the playable range are kept for interpolation
 * but the min/max range fields decide what counts as a valid shot.
 */
...
export const DEFAULT_WEAPON_ID = 'mortar';
